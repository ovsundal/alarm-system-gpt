...
from chat.services.tools.EvaluateTrendsTool import EvaluateTrendsTool
...
def get_agent_executor():
    ...
    tools = [ClassifyUserQueryTool(), ExtractParametersForPlottingTool(), FindInformationTool(), EvaluateTrendsTool()]
